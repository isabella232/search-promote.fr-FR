...
1. Dans le menu du produit, cliquez sur **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Account Settings]**.
1. Sur la [!DNL Account Settings] page, définissez les options de votre choix.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>Requis. </p> <p>Adresse URL de votre site Web. L'adresse spécifiée ici est utilisée comme point d'entrée principal du site Web. </p> <p>Voir aussi <a href="../c-about-settings-menu/c-about-crawling-menu.md#task_2338A47387D74CFDAC4D4EF4A367ED45" type="task" format="dita" scope="local"> Ajout de plusieurs points d’entrée d’URL à indexer </a>. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>Valide tous les attributs dans <span class="codeph"> &lt;guided-*&gt; </span> et <span class="codeph"> &lt;search-*&gt; </span> lorsque vous enregistrez un modèle dans l’éditeur de modèles d’évaluation. </p> <p>Voir <a href="../c-about-design-menu/c-about-templates.md#task_800E0E2265C34C028C92FEB5A1243EC3" type="task" format="dita" scope="local"> Modification d’une présentation ou d’un modèle de transport </a>. </p> </td> 
      </tr> 
      <tr> 
      ...
      <tr> 
      <td colname="col1"> <p>Contrôle strict de la syntaxe des modèles </p> </td> 
      <td colname="col2"> <p>Rend le validateur de modèle plus strict et permet de vérifier des éléments tels que les guillemets non équilibrés et les symboles &lt;&gt;. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Numéro de compte </p> </td> 
      <td colname="col2"> <p>Vous ne pouvez pas modifier le numéro de compte. Il est destiné uniquement à l’affichage. </p> </td> 
      </tr> 
    </tbody> 
    </table>
...
1. Dans Adobe CQ5, utilisez l’onglet Services Cloud pour créer la configuration de recherche/marchandisage de votre site.
...
1. Dans le menu du produit, cliquez sur **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Merchandising Preferences]**.
1. Sur la [!DNL Merchandising Preferences] page, définissez les options de votre choix.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p> Pourcentage de seuil à appliquer aux déclencheurs basés sur les résultats "dominant le groupe" qui spécifient "utiliser le compte par défaut". </p> <p>La modification de ce paramètre peut immédiatement avoir un effet sur les recherches en direct. Utilisez-le donc avec précaution. </p> </td> 
      </tr> 
      <tr> 
...
## Configuration de l’accès à votre compte Adobe Dynamic Media Classic {#task_CEFF88C2033D41D0B2FE86C435EDAC6D}
...
1. Dans le menu du produit, cliquez sur **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Scene7 Configuration]**.
1. Sur la [!DNL Scene7 Configuration] page, définissez les options de votre choix.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>Requis. Identifie la région du monde dans laquelle votre compte Contenu multimédia dynamique classique accède aux différents serveurs Contenu multimédia dynamique. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Société par défaut </p> </td> 
      <td colname="col2"> <p>Identifie le nom de l’entreprise associée à votre compte Dynamic Media Classic. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p> Courrier électronique </p> </td> 
      <td colname="col2"> <p>Requis. Identifie votre adresse électronique utilisée pour la connexion et les communications de Dynamic Media Classic. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Mot de passe </p> </td> 
      <td colname="col2"> <p>Requis. Votre mot de passe de connexion à Dynamic Media Classic. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Activé </p> </td> 
      <td colname="col2"> <p>Active tous les contrôles de Dynamic Media Classic dans la recherche/le marchandisage sur le site. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Test </p> </td> 
      <td colname="col2"> <p>Vérifie que le nom de la région, l’adresse électronique et le mot de passe de la région de Dynamic Media Classic sont corrects. </p> </td> 
      </tr> 
    </tbody> 
    </table>

1. (Facultatif) Cliquez sur **[!UICONTROL Test]** pour vérifier que le nom de la région, l’adresse électronique et le mot de passe de la région Dynamic Media Classic sont corrects.
1. Cliquez sur **[!UICONTROL Save Changes]**.

## Configuration du redirecteur Adobe Analytics {#task_2C9DE333FD7246E4A460FC0F55204160}

Si vous utilisez [!DNL Adobe Analytics] pour le suivi des visiteurs du site, vous pouvez utiliser [!DNL Adobe Analytics Redirector] dans la recherche/marchandisage du site pour effectuer le suivi de toutes les redirections HTTP avec [!DNL Adobe Analytics].

**Pour configurer le redirecteur Adobe Analytics**

1. Dans le menu du produit, cliquez sur **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Adobe Analytics Redirector]**.
1. Sur la [!DNL Adobe Analytics Redirector] page, définissez les options de votre choix.
   ...
   <table> 
    ...
    <tbody> 
      <tr> 
      <td colname="col1"> <p>Activer la fonction Redirecteur d’Adobe Analytics </p> </td> 
      ...
      <li id="li_67A93D17C3A14874928C6DC4FF2D4784"> Dans la <span class="wintitle"> zone de </span> groupe Options, sélectionnez une suite de rapports dans la liste déroulante correspondante. </li> 
      <li id="li_5AAB004AC58441DBB0F813BDE30EFFD4"> Cliquez sur <span class="uicontrol">Générer le code </span>. </li> 
      <li id="li_E80368993F4D4DD69E37509FF4348B36"> Sur la page Gestionnaire de <span class="wintitle"> code </span> , cliquez sur l’onglet <span class="uicontrol"> Fichier JavaScript principal </span>. </li> 
      ...
      <li id="li_AAC47EAA04144A67BDCB5C7B8D8098E9"> Consultez la <span class="wintitle"> colonne Identifiant de suite de </span> rapports dans le tableau pour trouver l’identifiant. </li> 
      </ol> </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Paramètres personnalisés </p> </td> 
      <td colname="col2"> <p>Vous permet d’ajouter des paramètres personnalisés à l’URL de redirection d’Adobe Analytics. </p> </td> 
      </tr> 
      <tr> 
...
1. (Facultatif) Sur la [!DNL Adobe Analytics Redirector] page, effectuez l’une des opérations suivantes :
...
1. Dans le menu du produit, cliquez sur **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Root Files]**.
1. Sur la [!DNL Root Files] page, accédez aux fichiers racine que vous souhaitez télécharger.
   ...
   <table> 
    ...
    <tr> 
      ...
      <td colname="col2"> <p> Icône du site. Généralement, il est affiché dans la barre d’adresse du navigateur du client. </p> </td> 
    </tr> 
    <tr> 
    ...
    <tr> 
      ...
      <td colname="col2"> <p>Fichier XML contenant la liste de toutes les pages disponibles sur le site Web. </p> </td> 
    </tr> 
    <tr> 
      <td colname="col1"> <p>crossdomain.xml </p> </td> 
      <td colname="col2"> <p>Permet ou désactive Flash Player d’accéder aux fichiers entre domaines. </p> </td> 
    </tr> 
    </tbody> 
    </table>
...
1. (Facultatif) Recréez l’index du site d’évaluation si vous souhaitez prévisualiser les résultats.
   ...
   Voir [Configuration d’un index incrémentiel d’un site Web](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0)intermédiaire.
1. (Facultatif) Sur la [!DNL Root Files] page, effectuez l’une des opérations suivantes :
...
En tant que propriétaire de compte, si vous avez l’intention d’annuler votre connexion, vous devez d’abord transférer la propriété à un autre utilisateur de compte actif. Vous pouvez l’utiliser [!DNL Transfer Ownership] pour accomplir cette tâche.
...
1. Dans le menu du produit, cliquez sur **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Transfer Ownership]**.
1. Sur la [!DNL Transfer Ownership] page, cliquez sur l’utilisateur dont vous souhaitez prendre possession.
...
Voir [Transfert de la propriété du compte à un autre utilisateur](../c-about-settings-menu/c-about-account-options-menu.md#task_47E3C66CC6374274830DA10171E0CF17)de compte.
...
1. Dans le menu du produit, cliquez sur **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Remove Account]**.
1. (Facultatif) Dans le [!DNL Reason for Removal] champ, entrez un motif de suppression du compte.
...
1. Dans le menu du produit, cliquez sur **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Remove Yourself]**.
